'''
This script will validate the Cognito Token for signature, header, time of token expiration
and Client ID
Author: IBM
'''
import json
...
subprocess.check_call([sys.executable, "-m", "pip", "install", "--target", "/tmp", "python-jose[cryptography]"])
